...
/**
 * Print button
 * Add a Print button to the available buttons
 *
...
class SWP_Print extends SWP_Social_Network {
	...
	public function __construct() {
		...
		$this->name           =  __( 'Print', 'social-warfare-print' );
		$this->cta            =  __( 'Print', 'social-warfare-print' );
		$this->key            = 'print';
		$this->default        = true;
		$this->base_share_url = 'javascript:window.print()';
